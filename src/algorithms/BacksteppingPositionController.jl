...
"""
Base.@kwdef struct BacksteppingPositionController <: AbstractEnv
    Ap
    Bp
    P
    Kp
    ...
    function BacksteppingPositionController(m::Real)
        ...
        Q = Diagonal(1*ones(6))
        # thrust
        Kt = Diagonal(4*ones(6))
        # angular
        Kω = Diagonal(20*ones(6))
        # reference model
...
function dynamics!(env::BacksteppingPositionController)
    ...
    return function (dx_controller, x_controller, p_controller, t; pos_cmd, Tḋ)
